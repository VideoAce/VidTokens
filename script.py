...
def output(store):
    ...
    output_str = "# Global VidTokens Rankings\n\n|Ranking|Name|VidTokens|\n| ----------- | ----------- | ----------- |\n"
    ...
    output_str += "\n## !! Those Under -500 VidTokens will be [Executed Live](https://www.youtube.com/@VidyoAce) !!\n"
    # output_str += "\n## Top VidToken Updates Can be Found [Here](https://owenpoints.github.io/blog)\n\n\n## VidTokens Log:\n"
